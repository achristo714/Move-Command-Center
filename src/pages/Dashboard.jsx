  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 text-center">
        <h1 className="text-lg font-bold text-slate-800 mb-1">Move Command Center</h1>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4">
        <h2 className="font-semibold text-slate-800 mb-3">Status Breakdown</h2>
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-yellow-50 to-amber-50 rounded-2xl border border-yellow-200 p-4 text-left"
      >
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-semibold text-slate-800">Essentials Kit</h2>
          ...
          {rooms.slice(0, 5).map(room => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 active:bg-slate-100 transition-colors"
              >
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="bg-white rounded-xl border border-slate-200 p-4 text-left active:scale-[0.98] transition-transform"
        >
          <CheckCircle2 className="w-5 h-5 text-green-500 mb-2" />
          <div className="font-medium text-sm text-slate-800">Unpacking Queue</div>
        ...
        >
          ...
          <div className="font-medium text-sm text-slate-800">Print Labels</div>
            ...
            {activity.slice(0, 5).map(entry => {
              ...
              return (
                <div key={entry.id} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-slate-300 ml-auto text-xs">{timeAgo}</span>
                </div>
              )
            })}
          </div>
